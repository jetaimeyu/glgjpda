app.controller("bodyCtl", ["$scope", "ApiService", "DataService", "DatePickerService", "UtilsService", "CacheService", function($scope, ApiService, DataService, DatePickerService, UtilsService, CacheService) {
	...
	var subViews = {
		...
		map: {
			obj: "",
			init: function() {
				this.obj = createSubPage("resource-map-container.html", "resource-map-container.html", "84px", {
					disValue: $scope.domData.disValue,
					cPath: "",
					path:$scope.domData.path,
		...
		list: {
			obj: "",
			init: function() {
				this.obj = createSubPage("resource-map-list.html", "resource-map-list.html", "84px", {
					disValue: $scope.domData.disValue,
					cPath: "",
					path:$scope.domData.path,
					active: $scope.domData.active
