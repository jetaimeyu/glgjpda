...
app.controller("prodDisCtl", ["$scope", "ApiService", "DataService", "Loading", "DatePickerService", "$Modal", "UtilsService", "$filter", function($scope, ApiService, DataService, Loading, DatePickerService, modal, UtilsService, $filter) {
    ...
    var curData = {
        getData: function() {
            ...
            var url = ApiService.Api50 + "/api/v1/Prod/GetMdScanCodeListRecent?1=1";
        ...
        getScanInfo: function(mdcode, prodId, skuId, mdCode) {
            UtilsService.openWindow({
                needLogin: true,
        ...
        overlay: {
            ...
            getMarker: function(_index) {
                ...
                marker.addEventListener("click", function(e) {
                    ...
                    curData.getScanInfo(bMap.mapData[_index].MdCode, bMap.mapData[_index].ProductID, bMap.mapData[_index].SkuID, bMap.mapData[_index].MdCode);
                });
